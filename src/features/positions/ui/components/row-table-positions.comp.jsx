...
function RowTablePositions() {
  return (
    <Link
      to={`/teams/21-2`}
      className=" max-w-[1000px]  flex justify-between my-3 text-sm md:text-xl items-center bg-black h-14 rounded-xl  transition-all duration-400 md:cursor-pointer hover:bg-zinc-950"
    >
