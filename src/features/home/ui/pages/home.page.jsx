...
function HomePage() {
  return (
    <BorderAnimation>
    <div className="relative flex-1 space-y-4 h-full shadow-[0_0_10px_rgb(0,0,0,0.5)] shadow-gray-700 rounded-xl  bg-black">
      ...
      <div className="flex-1 space-y-4 md:space-y-30 h-full  relative ">
        <div className="space-y-4 p-2">
          <div className="flex-1 flex flex-wrap gap-x-4 gap-y-4 justify-center py-10">
            <div className="text-6xl bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent ">
              SEMANA FIIS
            </div>
          ...
          <div className="flex-1 md:w-full md:flex md:justify-center ">
            <div className="flex gap-x-2 md:gap-x-8 md:gap-y-6 gap-y-2 flex-wrap  p-4 md:w-[500px] md:justify-center justify-evenly">
              {Array(10)
                .fill(0)
                .map((_, index) => (
          ...
          <div className="w-full md:w-auto">
            <div className="bg-gray30 flex flex-col rounded-md gap-y-5 md:max-w-80 ">
              ...
              <div className="p-4 pt-0">
                ...
                architecto officia tenetur quas, dignissimos repellendus numquam
                nihil!
              </div>
            </div>
          </div>
