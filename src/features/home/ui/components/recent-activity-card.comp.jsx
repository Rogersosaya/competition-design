    ...
    <div className="bg-gradient-to-r from-gray30 p-0.5 to-primary rounded-md relative">
      <div className="bg-linear-to-r from-gray30 to-primary-dark  rounded-md flex p-4 items-center justify-end py-8">
        <div className="flex gap-x-4 md:gap-x-12">
          <div className="text-gold  md:text-4xl font-bold flex items-center gap-x-2">
            <div>
              <AiOutlineTrophy />
            </div>
            <div>21-2</div>
          </div>
          <div className="text-silver text-xs md:text-2xl font-bold flex items-center gap-x-2">
            <div>
              <AiOutlineTrophy />
            </div>
            <div>21-2</div>
          </div>
          <div className="text-bronze text-xs md:text-xl font-bold  flex items-center gap-x-2 ">
            <div>
              <AiOutlineTrophy />
            </div>
            <div>21-2</div>
